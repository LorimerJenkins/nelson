...
function launchTask(description, context, { sendResult, timeout = 600000 } = {}) {
  ...
  const prompt = `You are Nelson, running an autonomous background task. Complete this task fully and return the result.
...
- If you need to browse the web, use: node browse.js goto "url" or node browse.js screenshot "name"
- If you need to create files, create them in the project directory
